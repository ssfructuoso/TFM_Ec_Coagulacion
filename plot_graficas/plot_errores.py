...
####################################################
#### Obtencion de las cotas de error respecto a soluciones conocidas
#### Es utilizado en la sección 2.3 del trabajo para obtener las cotas de error de los metodos para los nucleos suma e identidad
####################################################


###En este caso se muestran los errores de volumenes finitos con RK3 y Trapecios compuesto
datos1Txt='ficheros_simulaciones/VOL_FINITOS/trapecios_comp/RK3/vol_finitos_RK3_ID_trapecios_compuesto_50.txt'
datos2Txt='ficheros_simulaciones/VOL_FINITOS/trapecios_comp/RK3/vol_finitos_RK3_ID_trapecios_compuesto_100.txt'
datos3Txt='ficheros_simulaciones/VOL_FINITOS/trapecios_comp/RK3/vol_finitos_RK3_ID_trapecios_compuesto_200.txt'
