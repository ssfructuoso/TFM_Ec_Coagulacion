...
plt.plot(xi,xi*g[pos1,:],'b',label="t="+str(tiempo1)+" min")
plt.plot(xi,xi*g[pos2,:],'g',label="t="+str(tiempo2)+" min")
plt.plot(xi,xi*g[pos3,:],'r',label="t="+str(tiempo3)+" min")
plt.plot(xi,xi*g[pos4,:],'m',label="t="+str(tiempo4)+" min")
...
plt.plot(np.log10(10**6*plot1[0]),np.log10(np.abs(plot1[1]+add1)),'b',label="t="+str(tiempo1)+" min")
####
plt.plot(np.log10(10**6*plot2[0]),np.log10(np.abs(plot2[1]+add1)),'g',label="t="+str(tiempo2)+" min")
####
plt.plot(np.log10(10**6*plot3[0]),np.log10(plot3[1]+add1),'r',label="t="+str(tiempo3)+" min")
####
plt.plot(np.log10(10**6*plot4[0]),np.log10(plot4[1]+add1),'m',label="t="+str(tiempo4)+" min")
