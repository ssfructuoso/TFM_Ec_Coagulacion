...
int main(int argc, char** argv) {
    ...
    cout<< "Seccional:---" << endl;
    Seccional secRK3 = Seccional("./simulaciones/seccional/2s-seccional_RK4_SUMA-simpson_comp_200");
    ...
    VolFinitos vol1=VolFinitos("./simulaciones/vol_finitos/2s-vol_finitos_RK4_ID_simp_comp_50");
