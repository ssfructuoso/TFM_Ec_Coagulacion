...
long double Seccional::coefB1(int i, int j, int l) {
    ...
    if (nParticionesX % 3 == 1) {
        nParticionesX = nParticionesX + 2;
    }
    if (nParticionesX % 3 == 2) {
        nParticionesX = nParticionesX + 1;
    }
    if (nParticionesY % 3 == 1) {
        nParticionesY = nParticionesY + 2;
    }
    if (nParticionesY % 3 == 2) {
        nParticionesY = nParticionesY + 1;
    }
    //
  ...
  /*
    ...
    //#####Bloque 2
    long double suma_bloque2; suma_bloque2=0;
    sum_aux=0;
    ...
    //## Bloque 3:
    long double suma_bloque3; suma_bloque3=0;
    sum_aux=0;
    ...
    sum_aux=0;
    for(int jtrapecio=1; j<=(nParticionesY/2);j++){
    ...
    //## Bloque 4:
    long double suma_bloque4; suma_bloque4=0;
