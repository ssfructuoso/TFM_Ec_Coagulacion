...
int main(int argc, char** argv) {
    ...
    /*
    cout<< "Seccional:---" << endl;
    Seccional secRK3 = Seccional("./simulaciones/seccional/2s-seccional_RK3_ID_simpComp_50");
    ...
    */
    ...
    VolFinitos vol1=VolFinitos("./simulaciones/vol_finitos/2s-vol_finitos_RK3_ID_simpson_compuesto_50");
